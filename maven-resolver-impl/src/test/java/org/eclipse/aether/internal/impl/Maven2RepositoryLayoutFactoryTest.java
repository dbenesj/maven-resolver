...
public class Maven2RepositoryLayoutFactoryTest
{
    ...
    private void assertChecksum( ChecksumLocation actual, String expectedUri, String checksumAlgorithmName )
    {
        assertEquals( expectedUri, actual.getLocation().toString() );
        assertEquals( checksumAlgorithmName, actual.getChecksumAlgorithmFactory().getName() );
    }

    private void assertChecksum( ChecksumLocation actual, String expectedUri, ChecksumAlgorithmFactory checksumAlgorithmFactory )
    {
        assertChecksum( actual, expectedUri, checksumAlgorithmFactory.getName() );
    }
