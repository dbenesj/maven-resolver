        ...
        implements RepositoryLayoutFactory
{
            ...
            throws NoRepositoryLayoutException
    {
        ...
        LinkedHashSet<String> checksumsAlgorithms = new LinkedHashSet<>( Arrays.asList( ConfigUtils.getString( session,
        ...
        {
            types.add( checksumAlgorithmFactorySelector.select( checksumsAlgorithm ) );
        }
