...
final class ChecksumValidator
{
    ...
    private final Map<File, Object> checksums;
    ...
    public ChecksumCalculator newChecksumCalculator( File targetFile )
    {
        ...
        {
            return ChecksumCalculator.newInstance( targetFile, checksumLocations.values() );
        }
        return null;
    }
        ...
        throws ChecksumFailureException
    {
        for ( Map.Entry<String, ?> entry : inlinedChecksums.entrySet() )
        {
            ...
            checksums.put( getChecksumFile( factory ), expected );
        ...
        throws ChecksumFailureException
    {
        for ( ChecksumLocation checksumLocation : checksumLocations.values() )
        {
            ...
            try
            {
                ...
                checksums.put( checksumFile, tmp );
    ...
    public void commit()
    {
        for ( Map.Entry<File, Object> entry : checksums.entrySet() )
        {
